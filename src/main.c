...
#define DEVICE_NAME                      "EmuBoy Keyboard"                          /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                "MOBIXLabs"                      /**< Manufacturer. Will be passed to Device Information Service. */
